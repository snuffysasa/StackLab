...
public class Stack<T> implements StackIF<T> {
	...
	public String toString() {
		//creates the start of our string "Stack["
		String string = "Stack[";
		//If the Stack is empty just add a "]" to the string and return it.
		if(theStack.isEmpty()){
			return string + "]";
		}
		//If the Stack is not empty it adds each item from the list into the string as a string.
		else {
